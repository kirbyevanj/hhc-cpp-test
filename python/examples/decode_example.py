#!/usr/bin/env python3
"""
Example demonstrating HHC decoding functionality in Python.
"""
...
def main():
    print("HHC Python Decoding Example")
    print("===========================\n")
    ...
    for encoded in encoded_32:
        result = decode_with_error_handling(hhc.decode_32bit, encoded, 32)
    ...
    for encoded in encoded_64:
        result = decode_with_error_handling(hhc.decode_64bit, encoded, 64)
    ...
    for original in test_values:
        ...
        encoded = hhc.encode_unpadded_32bit(original)
    ...
    for i in range(1_000_000):
        encoded = hhc.encode_unpadded_32bit(i)
        if encoded:  # Skip empty string for 0
            decoded = hhc.decode_32bit(encoded)
