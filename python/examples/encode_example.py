#!/usr/bin/env python3
"""
Example demonstrating HHC encoding functionality in Python.
"""

import hhc

def main():
    print("HHC Python Encoding Example")
    print("===========================\n")
    ...
    print(f"HHC Alphabet: '{hhc.ALPHABET}'")
    print(f"32-bit encoded length: {hhc.HHC_32BIT_ENCODED_LENGTH} characters")
    print(f"64-bit encoded length: {hhc.HHC_64BIT_ENCODED_LENGTH} characters")
